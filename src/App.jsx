  ...
  return (
    <div className="min-h-svh flex flex-col items-center justify-center px-4 py-16" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <div className="relative z-10 w-full max-w-[560px] mx-auto flex flex-col items-center text-center">
        ...
        >
          <a
            href="https://chat.whatsapp.com/Ef9DtIArOFv50V2YSYVvOn?mode=hq2tcli"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2.5 px-8 py-[13px] bg-[#25D366] text-white! alt text-[15px] font-semibold rounded-[12px] hover:bg-[#1ebe5d] transition-all duration-150 ease-out"
          >
          ...
          <a
            href="/"
            className="alt text-[13px] text-alt hover:text-text transition-colors duration-150"
          >
            ← Back to homepage
          </a>
        </Motion.div>
